...
<Diagram id="img-p306-0" caption="그림 1 — 평가 및 모니터링 모범 사례" alt="평가 및 모니터링 모범 사례 다이어그램" />
...
<Diagram id="img-p319-0" caption="그림 2 — 에이전트 간 계약 실행 예시" alt="에이전트 간 계약 실행 예시 다이어그램" />
...
<Diagram id="img-p321-0" caption="그림 3 — Google ADK의 평가 지원" alt="Google ADK 평가 지원 다이어그램" />
...
<Diagram id="img-p322-0" caption="그림 4 — 평가 및 모니터링 디자인 패턴" alt="평가 및 모니터링 디자인 패턴 다이어그램" />
