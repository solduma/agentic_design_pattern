...
- **컴플라이언스(Compliance) 및 안전성 감사**: 에이전트의 윤리 지침·규제 요건·안전 프로토콜 준수 여부를 추적하는 자동화된 감사 보고서를 생성합니다. 이 보고서는 Human-in-the-Loop 또는 다른 에이전트가 검증할 수 있으며, KPI를 생성하거나 문제 발견 시 알림을 트리거할 수 있습니다.
