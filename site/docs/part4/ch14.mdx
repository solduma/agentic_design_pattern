---
title: "14장 — RAG (Retrieval-Augmented Generation)"
sidebar_position: 14
---
...
# 14장: RAG (Retrieval-Augmented Generation)
...
<figcaption>그림 1: RAG 핵심 개념 — 쿼리 임베딩과 외부 문서 청킹·임베딩을 벡터 DB에서 유사도 검색하여 응답 합성</figcaption>
</figure>
...
<figcaption>단순 RAG와 에이전틱 RAG 비교 — 벡터 검색 기반 단순 파이프라인 대 다중 소스 도구 선택 방식</figcaption>
</figure>
...
<figcaption>지식 검색 패턴 — 에이전트가 데이터베이스에서 정보를 검색하여 응답 생성</figcaption>
</figure>
...
<figcaption>그림 3: 지식 검색 패턴 — AI 에이전트가 웹 검색을 통해 정보를 수집하고 합성하여 출력 생성</figcaption>
</figure>
